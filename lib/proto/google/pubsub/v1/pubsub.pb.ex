...
defmodule Google.Pubsub.V1.Topic do
  ...
  @type t :: %__MODULE__{
          ...
          message_storage_policy: Google.Pubsub.V1.MessageStoragePolicy.t()
        }
  defstruct [:name, :labels, :message_storage_policy]
...
defmodule Google.Pubsub.V1.Subscription do
  ...
  @type t :: %__MODULE__{
          ...
          labels: %{String.t() => String.t()},
          expiration_policy: Google.Pubsub.V1.ExpirationPolicy.t()
        }
  defstruct [
    :name,
    :topic,
